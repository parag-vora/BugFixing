//BUG: Bug/original_code.c
//

//Fix: Bug/fixed_code.c
...
int main() {
    ...
    char str[6] = "hello"; // Missing null terminator
    printf("\n%s\n", str); // May cause unexpected output or crash
    printf("Length of str: %zu\n", strlen(str)); // Correctly prints length of string
    printf("Size of str array: %zu\n", sizeof(str)); // Correctly prints size of array
